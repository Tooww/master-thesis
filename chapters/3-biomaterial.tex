...
This is the part that takes up the most space in traditional designs. here, all the push space is removable. The PVC sides can be deflated and then folded. the aluminum profiles can be removed to take up less space.
