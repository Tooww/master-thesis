...
on the one hand, alkolic fermentation by leaven. In other words, the glucoses (C_6H_{12}O_6) \text{will be converted into ehtanol} (CH_3CH_2OH). 
\text{On the other hand, “acetic fermentation” by bacteria. In other words, the ethanol} (CH_3CH_2OH) \text{will be converted into acetic acid.}
