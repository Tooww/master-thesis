...
% \begin{marginfigure}
%     \centering
%     \includegraphics{images/OXMAN.png}    
%     \caption{}
%     \label{fig:}
% \end{marginfigure}
% \begin{marginfigure}
...
\- A controller that reads sensor values and decides whether to activate actuators, and optionally saves or sends data for analysis or monitoring. 
...
The projet of Roussel combines the techniques described earlier by jen keane and rotary bioreactors.
