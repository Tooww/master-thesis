...
\begin{figure}
    \centering
    \includegraphics[width=1.8\textwidth]{images/mapping-practices-kombu.png} % Adjust width to 80% of text width
...
\begin{figure}
    \centering
    \includegraphics[scale=3]{images/mapping-practices-kombu.png} % Scales image to 150% of its original size
...
BC tubes hold promise as a biocompatible, durable material for use in vascular tissue engineering and potentially in the development of artificial blood vessels.
