...
% Redefine the title of the ToC
\renewcommand{\contentsname}{Contents} % Set the title to "Contents"
...
% Insert the title for ToC and the horizontal line
\begin{center}
    \textbf{\contentsname} \\ % Title of the ToC
